 ...
 * ```
 */
export declare const createClient: <P extends Api, App extends Readonly<{
    [name: string]: Api;
}> = Readonly<import("../../../../../dist/packages/api").IRemixApi>>(websocket: WS, client?: PluginClient<P, App>) => Client<P, App>;

...
it("Should Show correct number of 1st count votes for both parties (5 0) after voting",async ()=>{
    for(let i = 1; i<=5; i++){
        //console.log(i);
    ...
    assert.equal(_01stCount,5,"Party index 0 incorrect number of votes.");
    let _11stCount = await district.party1stCountVotes(1);
    assert.equal(_11stCount,0,"Party index 0 incorrect number of votes.");
